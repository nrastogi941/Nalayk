                                ...
                                <div className="row">
                                    ...
                                    {/* <div  style={{ border: "2px solid black", marginTop:200}}> */}
                                        ...
                                        <h5 className=""> Competitive Programmer, Front End web developer </h5>
                                         {/* <div className="mt-3"> */}
                                        <a className="btn btn-get-started" href="https://drive.google.com/file/d/1f_2tvS4u4ZgvjpHGYJLPFMNBRY5Lw3tF/view?usp=sharing" target="_blank"> Resume(Open to Work)</a>
                                        {/* </div>  */}
                                        {/* </div> */}
                                    </div>
